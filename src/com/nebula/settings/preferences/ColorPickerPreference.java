...
package com.nebula.settings.preferences;
...
import com.nebula.settings.NebulaSettings;
import com.nebula.settings.preferences.ColorPickerDialog.OnColorChangedListener;
...
public class ColorPickerPreference extends Preference implements OnPreferenceClickListener, OnColorChangedListener {
    ...
    protected void showDialog(Bundle state) {
        if (mDialog == null || !mDialog.isShowing()) {
            ...
            NebulaSettings.lockCurrentOrientation((SettingsActivity) getContext());
